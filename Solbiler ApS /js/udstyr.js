...
LEJEASIDE.insertAdjacentHTML("beforeend", `<br><br><h3>Billeje ex udstyr: ${parseFloat(URLDATA.get('lejeudgift')).toLocaleString('da-DK', { style: 'currency', currency: 'DKK' })}</h3>inkl. moms`);
